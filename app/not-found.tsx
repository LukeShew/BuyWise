...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 lg:px-8">
      ...
      <h1 className="mt-2 text-4xl font-black text-ink">This product is not in the mock catalog</h1>
      <p className="mt-3 text-stone-600">Search the current MVP products or check a product link.</p>
